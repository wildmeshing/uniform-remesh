...
int main(int argc, char **argv)
{
    ...
    // double target_edge_length = (argc > 1) ? std::stod(std::string(argv[1])) : 0.04;
    ...
    double stop_ratio = (argc > 1) ? std::stod(argv[2]) : 0.1;
    std::cout << "it is runnng" << std::endl;
